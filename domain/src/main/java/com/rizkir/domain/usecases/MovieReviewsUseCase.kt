...
) : BaseUseCases<MovieReviewsUseCase.Params, List<MovieReviewEntity>> {
    data class Params(val movieId: Int)
    override suspend fun execute(params: MovieReviewsUseCase.Params?): Flow<Result<List<MovieReviewEntity>>> {
